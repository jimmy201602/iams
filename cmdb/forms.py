...
class AssetForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'port': TextInput(attrs={'class': 'form-control', 'style': 'width:530px;', 'placeholder': '必填项'}),
...
class GroupForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name': TextInput(attrs={'class': 'form-control','style': 'width:450px;'}),
            'desc': TextInput(attrs={'class': 'form-control','style': 'width:450px;'}),
        }
