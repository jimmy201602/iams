...
urlpatterns = [
    ...
    #url(r'^asset/webssh/$', asset.asset_webssh, name='asset_webssh'),
    #url(r'^asset/terminal/$', asset.gateone_terminal, name='gateone_terminal'),
    #url(r'^asset/auth/$', asset.geteone_auth, name='geteone_auth'),

    #url(r'^export/$', asset.export, name='export'),
